...
const BicycleCard = () => {
  ...
  return (
    <div className="flex justify-center items-center">
      <div className="">
        <h1 className="text-4xl text-black text-center pb-4 font-semibold">
          Featured Bicycles
        </h1>
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-end gap-2 items-center mt-4">
                      ...
                      <button className="px-4 border border-gray-500 py-2 text-[12px] text-black rounded-lg hover:bg-blue-700 bg-gradient-to-r from-[#a144df] to-[#010113] hover:opacity-90 transition duration-300">
                        Buy Now
                      </button>
                    </div>
                  </div>
