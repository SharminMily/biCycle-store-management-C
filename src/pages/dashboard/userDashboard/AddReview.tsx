  ...
  return (
    <div className="mt-16">
      <div className="max-w-md mx-auto p-4 border rounded-lg shadow-lg bg-white">
        <h2 className="text-2xl text-black font-semibold text-center mb-1">
          Add a Review
        </h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className="px-6 py-3  border border-gray-500 text-sm text-black rounded-lg hover:bg-blue-700 bg-gradient-to-r from-[#a144df] to-[#010113] hover:opacity-90 transition duration-300"
            >
              Submit Review
            </button>
          </div>
